...
COLUMNS = [
    ...
    (None,                   None,                            "blank"),
    # Right-side billing block — TOTAL GROSS (Net + employee GOSI) + employer
    # GOSI + fees, matching the Elite format's "Charge to Clients" block.
    ("TOTAL GROSS",          None,                            "computed:charge_base"),
